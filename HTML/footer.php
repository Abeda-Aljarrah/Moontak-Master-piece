        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="social-links mt-5">
                            <ul class="d-flex list-unstyled gap-2">
                                ...
                                <li>
                                    <a href="#" class="btn btn-outline-light">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                                            <path fill="currentColor" d="M19,4H5A3,3,0,0,0,2,7V17a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V7A3,3,0,0,0,19,4Zm-.67,2L12,10.75,5.67,6ZM19,18H5a1,1,0,0,1-1-1V7.25l7.4,5.55a1,1,0,0,0,.6.2,1,1,0,0,0,.6-.2L20,7.25V17A1,1,0,0,1,19,18Z" />
                                        </svg>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="footer-menu">
                        <h3 class="widget-title">Moontak</h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <img src="../image/Delivery_concept_handsome_caucasian_featuring_delivery__food__and_courier-removebg-preview.png" alt="" class="delivery-gay" />
                </div>
            </div>
        </div>
    </footer>
